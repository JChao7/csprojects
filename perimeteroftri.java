...
public class PalindomePrimeNum {
    ...
    public static Boolean verifyTriangle(int point1_x, int point1_y, int point2_x, int point2_y, int point3_x,
        ...
        int lineA = (Math.sqrt(Math.pow(point2_x - point1_x, 2))) + (Math.sqrt(Math.pow(point2_y - point1_y, 2)));
        int lineB = (Math.sqrt(Math.pow(point3_x - point2_x, 2))) + (Math.sqrt(Math.pow(point3_y - point2_y, 2)));
        int lineC = (Math.sqrt(Math.pow(point3_x - point1_x, 2))) + (Math.sqrt(Math.pow(point3_y - point1_y, 2)));
